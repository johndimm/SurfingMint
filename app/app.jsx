var Bar = React.createClass({
  render: function() {
    ...
    return (
      <div className="Bar" style={style}>{this.props.category}</div>
    );
  }
})
;
...
var Timeline = React.createClass({
  render: function() {
    var line = this.props.quarters.map(function(key,i) {
      ...
      return (
        <span key={i} onClick={this.props.onClickHandler} title={key} style={style}>|</span>
      );
    }.bind(this));
    return (
      <div>{line}</div>
...
var Detail = React.createClass({
  ...
  render: function() {
    var lines = this.state.data.map(function(key,i) {
       return (
         <div key={i}>{key.Date} {key.Amount} {key.Description} {key['Original Description']}</div>
       );
    });
    return (
      <div>
...
//
  ...
  render: function() {
    ...
    <div>
        <div id="chartDiv">
            <div id="pieChart"></div>
            <Timeline quarters={this.state.quarters} onClickHandler={this.jump} quarter={this.state.quarter}/>
        ...
        <div id="detailDiv">
          <Detail quarter={this.state.quarter} category={this.state.category} />
        </div>
    </div>
    );
  }
